...
import 'package:hbe/views/sales/generate_po/generatePO.dart';
...
class AddPOInvoice extends StatefulWidget {
  const AddPOInvoice({Key? key}) : super(key: key);

  @override
  State<AddPOInvoice> createState() => _AddPOInvoiceState();
}

class _AddPOInvoiceState extends State<AddPOInvoice> {
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Add Purchase Order",style: TextStyle(fontFamily: "Poppins-Medium",fontSize: 16),),
        centerTitle: true,
      ),
                    ...
                    child: Align(
                        ...
                        child: CustomButton(onTap: (){
                          if(_selectedCustomer==null){
                            ...
                            AppRoutes.push(context, PageTransitionType.fade, GeneratePO(cID: result12.toString(),date: dateController.text.toString(),));
                          }
                        }, color: greenBasic, text: "GENERATE PURCHASE ORDER",width: MediaQuery.of(context).size.width,)))
              ],
            ),
          ),
        ),
