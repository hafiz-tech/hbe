...
import 'package:hbe/views/sales/generate_daily_sale/generate_DS.dart';
import 'package:hbe/views/stock/generate_stock.dart';
...
class AddDailySale extends StatefulWidget {
  bool isFromStock;
   AddDailySale({Key? key,required this.isFromStock}) : super(key: key);

  @override
  State<AddDailySale> createState() => _AddDailySaleState();
}

class _AddDailySaleState extends State<AddDailySale> {
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.isFromStock?"Add Stock Detail":"Add Daily Sale",style: TextStyle(fontFamily: "Poppins-Medium",fontSize: 16),),
        centerTitle: true,
      ),
                        ...
                        child: CustomButton(onTap: (){
                          if(_selectedCustomer==null){
                           ...
                           if(widget.isFromStock){
                             AppRoutes.push(context, PageTransitionType.fade, GenerateStock(cID: result12.toString(),date: dateController.text.toString()));

                           }
                           else{
                             AppRoutes.push(context, PageTransitionType.fade, GenerateDS(cID: result12.toString(),date: dateController.text.toString(),));
