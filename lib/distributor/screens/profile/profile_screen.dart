...
class DistributorProfileScreen extends StatefulWidget {
  bool fromTab;
   DistributorProfileScreen({Key? key,required this.fromTab}) : super(key: key);
...
class _DistributorProfileScreenState extends State<DistributorProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: widget.fromTab?role.toString()=="Distributor"? DistributorDrawer():DistributorDrawer():null,
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                  onTap: (){
                    AppRoutes.push(context, PageTransitionType.fade, DistributorChangePassword());
                  },
