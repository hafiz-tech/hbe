import 'dart:convert';
import 'dart:io';
import 'package:hbe/distributor/screens/reports/report_pdf.dart';
...
class DistributorReports extends StatefulWidget {
  const DistributorReports({Key? key}) : super(key: key);

  @override
  State<DistributorReports> createState() => _DistributorReportsState();
}

class _DistributorReportsState extends State<DistributorReports> {
  bool isLoading = true;
  ...
  Future<void> getAttendanceReportName() async{
    try {
      final response = await http.get(
          Uri.parse('${ApiUrls.distributorUrl}${ApiUrls.getAttendanceReportName2}'),
          headers: {
  ...
  Future<void> getSaleAndTargetReportName() async{
    try {
      final response = await http.get(
          Uri.parse('${ApiUrls.distributorUrl}${ApiUrls.getSaleReportName2}'),
          headers: {
            ApiUrls.key_name: ApiUrls.apikey,
          });
