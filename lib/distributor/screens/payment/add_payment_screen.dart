...
class _AddPaymentScreenState extends State<AddPaymentScreen> {
  ...
  void initState() {
    ...
    chequeDateController.text = DateFormat('yyyy-MM-dd').format(DateTime.now()).toString();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Add Payment",style: TextStyle(fontFamily: "Poppins-Medium",fontSize: 16),),
        centerTitle: true,
      ),
