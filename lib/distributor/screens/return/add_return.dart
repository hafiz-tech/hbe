  ...
  void getMappedCustomers() async{
    try {
      final response = await http.get(
          Uri.parse('${ApiUrls.baseURL}${ApiUrls.getMappedCustomerR}?UserID=${globalData.userId}'),
          headers: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Add Return Sale",style: TextStyle(fontFamily: "Poppins-Medium",fontSize: 16),),
        centerTitle: true,
      ),
                    ...
                    child: Align(
                        ...
                        child: CustomButton(onTap: (){
                          if(_selectedCustomer==null){
                            ...
                            AppRoutes.push(context, PageTransitionType.fade, GenerateReturn(cID: result12.toString(),date: dateController.text.toString(),));

                          }
                        }, color: greenBasic, text:"GENERATE RETURN SALE",width: MediaQuery.of(context).size.width,)))
              ],
            ),
          ),
        ),
